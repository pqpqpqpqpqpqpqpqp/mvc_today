	...
	<div class="content">
		...
		<div class="travel_info">
			<div class="info_item">
				...
				<span class="info_label">여행지</span> <span class="info_value"><%=boardVO.getTravelLocation()%></span>
			</div>
			<div class="info_item">
				<svg class="info_icon" viewBox="0 0 24 24">
                    <path
				...
				<span class="info_label">여행기간</span> <span class="info_value"><%=boardVO.getTravelPeriod()%></span>
			</div>
			<div class="info_item">
				<svg class="info_icon" viewBox="0 0 24 24">
                    <path
				...
				<span class="info_label">예산</span> <span class="info_value budget">
					<%
		...
		<div class="meta_info">
			<div class="metaItem">
				...
				조회수
				<%=boardVO.getViewCount()%>
			</div>
			<a
			<% if (userId != null && userId.equals(boardVO.getInstUser())) { %>
			 class="likeBtn">
			<% } else { %>
			 href="like.bo?board_idx=<%=boardVO.getBoardIdx()%>" class="likeBtn">
			<% } %>
				 <svg class="metaIcon" viewBox="0 0 24 24">
                    <path
						d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                </svg> 좋아요 <%=boardVO.getLikeCount()%>
			</a>
		</div>
		...
		<div class="bottom_area">
			...
			if (userId != null && userId.equals(boardVO.getInstUser())) {
			%>
			<input type="button" class="updateBtn btn" value="수정하기"
				onclick="boardUpdate()"> <input type="button"
				class="deleteBtn btn" value="삭제하기" onclick="boardDelete()">
			<%
			}
			%>
		</div>
