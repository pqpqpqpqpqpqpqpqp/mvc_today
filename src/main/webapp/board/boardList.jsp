...
<body>
	...
	<div class="content">
		...
		<div class="searchArea">
			<form action="list.bo" method="get" class="searchForm">
				<select name="category" class="categorySelect">
					...
					<option value="국내여행"
						<%=request.getParameter("category") != null && request.getParameter("category").equals("국내여행") ? "selected" : ""%>>국내여행</option>
					<option value="해외여행"
						<%=request.getParameter("category") != null && request.getParameter("category").equals("해외여행") ? "selected" : ""%>>해외여행</option>
					<option value="맛집"
						<%=request.getParameter("category") != null && request.getParameter("category").equals("맛집") ? "selected" : ""%>>맛집</option>
					<option value="숙소"
						<%=request.getParameter("category") != null && request.getParameter("category").equals("숙소") ? "selected" : ""%>>숙소</option>
					<option value="기타"
						<%=request.getParameter("category") != null && request.getParameter("category").equals("기타") ? "selected" : ""%>>기타</option>
				</select>
		...
		<a href="write.bo" class="writeBtn"> <svg class="writeIcon"
				viewBox="0 0 24 24">
                <path
		...
		<div class="boardGrid">
			...
			<div class="boardCard">
				<div class="cardHeader">
					...
					<a
						href="/250512_Today/board/detail.bo?board_idx=<%=vo.getBoardIdx()%>"
						class="cardTitle"> <%=vo.getBoardTitle()%>
					</a>
				</div>
				<div class="cardContent">
					<div class="cardMeta">
						...
						<div
							class="metaItem budgetItem <%=vo.getTravelBudget() <= 100000
		? "budget_low"
		: (vo.getTravelBudget() <= 500000
				? "budget_medium"
